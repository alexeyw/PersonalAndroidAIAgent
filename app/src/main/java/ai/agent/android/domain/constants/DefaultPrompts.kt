...
object DefaultPrompts {
    ...
    const val INTENT_ROUTER_PROMPT = "You are an Intent Router. Analyze the user input and determine if it's a simple message, complex question, or task. Output a single keyword representing the category."
