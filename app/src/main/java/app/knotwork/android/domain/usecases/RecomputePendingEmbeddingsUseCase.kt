 ...
 * ([app.knotwork.android.data.services.MemoryReembedWorker]) that an import schedules
 * via [app.knotwork.android.domain.services.MemoryReembedScheduler]. Retrieval never
...
class RecomputePendingEmbeddingsUseCase @Inject constructor(
     ...
     * @throws app.knotwork.android.domain.services.EmbeddingException if the batch
