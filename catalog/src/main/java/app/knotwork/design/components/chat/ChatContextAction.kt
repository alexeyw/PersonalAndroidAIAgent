 ...
 * small dropdown with copy / re-run / rate. The catalog component only
 * surfaces the user's choice via `onContextAction(action)` — the screen
 * decides what each action does (copy to clipboard, replay the prompt,
