 ...
 * small dropdown with copy / re-run / rate / save-to-memory, plus report on
 ...
 * does (copy to clipboard, replay the prompt, open the rating sheet, persist
 * the message to long-term memory, raise the report dialog).
 */
