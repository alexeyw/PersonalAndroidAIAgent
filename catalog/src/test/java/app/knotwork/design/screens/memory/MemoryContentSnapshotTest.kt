...
/**
 * Roborazzi snapshot baseline for `MemoryContent`. Covers the minimum
 * required by the task spec (empty / populated / error) in both themes,
 * plus searching with results and the no-match variant.
 */
